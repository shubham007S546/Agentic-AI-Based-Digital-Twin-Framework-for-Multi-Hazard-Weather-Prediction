"""XGBoost-specific helper functions."""
...
def build_config_from_args(args: argparse.Namespace) -> XGBoostConfig:
...
def add_common_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--experiment-name", dest="experiment_name", default="xgb_experiment")
...
def add_xgb_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--min-child-weight", dest="min_child_weight", type=float, default=1.0)
    ...
    parser.add_argument("--tree-method", dest="tree_method", default="hist", choices=["hist", "approx", "exact"])
